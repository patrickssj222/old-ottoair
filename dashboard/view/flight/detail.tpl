      ...
      <div class="row row-same-height">
          ...
          <div class="col-md-4">
            <div class="padding-30 sm-padding-5 sm-m-t-15">
              ...
              <?php } else { ?>
                <h5 style="padding-top: 12px; border-top: 1px solid #eeeeee;"><?=$text_paid?></h5>
        ...
        <div class="padding-20 sm-padding-5 sm-m-b-20 sm-m-t-20 bg-white clearfix">
            <?php if ($balance > 0) { ?>
            <button class="btn btn-success btn-cons btn-animated from-left fa fa-credit-card pull-right" type="button" onclick="paymentModal()">
