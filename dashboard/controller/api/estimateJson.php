 ...
 * Jack 2018-09-28
 */
class ControllerApiEstimateJSON extends Controller {
    ...
    public function index()
    {
        ...
        echo '<pre>';
        echo json_encode(json_decode($output, true), JSON_PRETTY_PRINT);
        echo '</pre>';
        exit;
        ...
        // echo '<pre>';
        // echo json_encode($flights['Carriers'], JSON_PRETTY_PRINT);
        // echo json_encode($flights['Places'], JSON_PRETTY_PRINT);
        // echo '</pre>';
        // exit;
