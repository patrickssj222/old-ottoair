...
class ModelFlight extends Model
{
    ...
    public function flightPayment($flight_id, $amount, $data)
    {
        $this->db->query("UPDATE " .DB_PREFIX. "flight SET payment = '" . (float)$amount . "', data='" . $this->db->escape(json_encode($data)) . "' WHERE flight_id = ".$flight_id);
    }
}
